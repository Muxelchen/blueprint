      ...
      days.push(
        ...
        >
          <div className="flex flex-col h-full">
            <span
              className={`${compact ? 'text-xs' : 'text-sm'} font-medium ${isToday(date) ? 'text-blue-700' : 'text-gray-700'}`}
            >
              {day}
            </span>
    ...
    >
      ...
      <div className={`grid grid-cols-7 gap-0 ${compact ? 'mb-1' : 'mb-2'}`}>
        {dayNames.map(day => (
          <div
            key={day}
            className={`${compact ? 'p-1' : 'p-2'} text-center ${compact ? 'text-xs' : 'text-sm'} font-medium text-gray-600 bg-gray-50`}
          >
      ...
      {selectedDate && !compact && (
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <h5 className="font-medium mb-3">Events for {selectedDate.toLocaleDateString()}</h5>
      ...
      {showUpcoming && !compact && (
        <div className="mt-6">
          ...
          <div
            ...
            style={{ maxHeight: dimensions.upcomingEventsHeight }}
          >
      ...
      {showStats && (
        <div
          className={`${compact ? 'mt-3' : 'mt-6'} grid grid-cols-4 gap-${compact ? '2' : '4'} text-center`}
        >
