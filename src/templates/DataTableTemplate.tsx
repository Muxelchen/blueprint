...
export const DataTableTemplate: React.FC = () => {
  ...
  const sampleData = [
    ...
    { id: 3, name: 'Bob Johnson', email: 'bob@example.com', role: 'Editor', status: 'Inactive', joined: '2024-03-10' },
    { id: 4, name: 'Alice Brown', email: 'alice@example.com', role: 'User', status: 'Active', joined: '2024-03-25' },
  ];
      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button size="sm" leftIcon={<Plus />}>Add User</Button>
          </div>
        </div>
      </div>
...
const StatsCard: React.FC<{ title: string; value: string; icon: string }> = ({ title, value, icon }) => (
...
const ActionCard: React.FC<{ icon: string; title: string; description: string }> = ({ icon, title, description }) => (
