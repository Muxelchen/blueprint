...
// TEST: Diese Datei sollte erlaubt sein
// firmen-dashboard-test/ sollte auch bei aktivem Schutz änderbar sein

console.log('🧪 Test: Diese Änderung sollte erlaubt sein, da firmen-dashboard-test/ nicht zum Blueprint-Kern gehört');
