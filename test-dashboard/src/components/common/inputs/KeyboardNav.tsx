...
const KeyboardNav: React.FC<KeyboardNavProps> = ({
  ...
  return (
    <KeyboardNavContext.Provider value={contextValue}>
      <div ref={containerRef} className={`keyboard-nav-container ${className}`} tabIndex={-1}>
        {/* Skip Links */}
        {skipLinks && (
      ...
      <div>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          ...
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            <li>
              • Use <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">↑</kbd>{' '}
              <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">↓</kbd> arrow keys for
              vertical navigation
            </li>
            <li>
              • Press <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">F1</kbd> or{' '}
              <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">?</kbd> to show keyboard
              shortcuts
            </li>
            <li>
              • Try <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">Ctrl+Home</kbd> and{' '}
              <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">Ctrl+End</kbd> to jump to
              first/last element
            </li>
            {customBindings && (
              <>
                <li>
                  • Press <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">Ctrl+K</kbd>,{' '}
                  <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">Alt+H</kbd>, or{' '}
                  <kbd className="px-1 py-0.5 bg-blue-100 rounded text-xs">Ctrl+Shift+D</kbd> for
                  custom shortcuts
                </li>
              </>
            )}
